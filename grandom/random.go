...
import (
	...
	"github.com/Mr-Harry/witty-tool/gslice"
	"github.com/google/uuid"
)

// Create an integer grandom number
...
// Create an integer grandom float
...
// Creates a grandom character of a specified length
func RandomCharacters(length int, intLength int) string {
	...
	result = gslice.SortRandomlyString(result)
