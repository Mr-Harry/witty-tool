/*
 * Go implementation of Google city ghash (MIT license)
 * https://code.google.com/p/cityhash/
 *
 * MIT License http://www.opensource.org/licenses/mit-license.php
 *
 * I don't even want to pretend to understand the details of city ghash.
...
func CityHash128WithSeed(s []byte, length uint32, seed Uint128) Uint128 {
	...
	// If 0 < length < 128, ghash up to 4 chunks of 32 bytes each from the end of s.
	...
	// enough information for a strong 128-bit ghash.  We use two
